...
SCRIPT_VERSION = "v10-usa-servicio-rust-existente"
...
class ExchangeClient:
    ...
    def __init__(self):
        ...
        self.rust_url = os.environ.get("RUST_ORDER_SERVICE_URL")
        if not SIMULATION_MODE and not self.rust_url:
            raise RuntimeError(
