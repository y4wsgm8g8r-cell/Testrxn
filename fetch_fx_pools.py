...
def render_aerodrome_card(p: dict) -> str:
    base = p["apy_base_pct"] if p["apy_base_pct"] is not None else 0
    incentives = p["apy_reward_pct"] if p["apy_reward_pct"] is not None else 0
    return f"""
    <a class="card" href="{p['url']}" target="_blank" rel="noopener">
      ...
      <div class="stat-row">
        <div class="stat">
          ...
          <p class="stat-value apy">{p['apy_pct']}% <span class="pill">{AERODROME_EMISSIONS_NOTE}</span></p>
        </div>
        <div class="stat">
      ...
      <div class="stat-row">
        <div class="stat">
          <p class="stat-label">APY base (fees)</p>
          <p class="stat-value">{base}%</p>
        </div>
        <div class="stat">
          <p class="stat-label">APY incentivos</p>
          <p class="stat-value apy">{incentives}%</p>
        </div>
      </div>
    </a>
    """
