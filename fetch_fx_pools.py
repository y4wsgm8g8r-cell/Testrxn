...
def collect_pendle_fxsave_market() -> dict | None:
    ...
    try:
        ...
        yt_apy_raw = find_apy(("ytFloatingApy", "longYieldApy"))
        ...
        def yt_to_pct(raw: float | None) -> float | None:
            # ytFloatingApy viene siempre en decimal (11.77 = 1177%).
            if raw is None:
                return None
...
def render_html(
    ...
    <a class="card" href="{PENDLE_ROCKAWAYX_YT_URL}" target="_blank" rel="noopener">
      ...
      <div class="stat-row">
        <div class="stat">
          <p class="stat-label">Floating APY</p>
