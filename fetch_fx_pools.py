    ...
    <a class="card" href="{FXSAVE_USDC_MARKET_URL}" target="_blank" rel="noopener">
      ...
      <div class="stat-row">
        <div class="stat">
          ...
          <p class="stat-value apy">{lend if lend is not None else '—'}{'%' if lend is not None else ''}</p>
        </div>
        <div class="stat">
          <p class="stat-label">Borrow Rate</p>
          <p class="stat-value">{borrow if borrow is not None else '—'}{'%' if borrow is not None else ''}</p>
        </div>
      </div>
      <div class="stat-row">
        <div class="stat">
...
def render_html(
    ...
    sections = [
        ...
        render_section("Morpho", market_html + lend_html + vault_html),
    ]
...
def main() -> None:
    ...
    html = render_html(market, vault, defillama, fxusd_mcap, fxsave_mcap, fxsave_apy, pendle_rockawayx, fxusd_peg_history, hydrex_pools, fxusd_mcap_history, compare_histories)
