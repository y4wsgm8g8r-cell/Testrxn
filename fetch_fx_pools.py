...
h1 { font-size: 2.3rem; font-weight: 900; margin-bottom: 0.25rem; display: flex; align-items: center; gap: 10px; color: #2f7dd8; }
.live-dot {
...
.subtitle { color: #2f7dd8; font-weight: 700; font-size: 1.1rem; margin-bottom: 2rem; }
.section-title {
  font-size: 1.7rem; font-weight: 900; margin: 2.5rem 0 0.85rem;
  color: #2f7dd8; text-transform: uppercase; letter-spacing: 0.03em;
}
