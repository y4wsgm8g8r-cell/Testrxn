...
h1 { font-size: 1.7rem; font-weight: 900; margin-bottom: 0.25rem; display: flex; align-items: center; gap: 10px; color: #000; }
.live-dot {
...
.subtitle { color: #000; font-weight: 700; font-size: 0.95rem; margin-bottom: 2rem; }
.section-title {
  font-size: 1.35rem; font-weight: 900; margin: 2.5rem 0 0.85rem;
